...
namespace Google\Site_Kit_Dependencies\TrueBV;

use Google\Site_Kit_Dependencies\TrueBV\Exception\DomainOutOfBoundsException;
use Google\Site_Kit_Dependencies\TrueBV\Exception\LabelOutOfBoundsException;
/**
...
class Punycode
{
    ...
    public function encode($input)
    {
        ...
        foreach ($parts as &$part) {
            $length = \strlen($part);
            if ($length < 1) {
                throw new \Google\Site_Kit_Dependencies\TrueBV\Exception\LabelOutOfBoundsException(\sprintf('The length of any one label is limited to between 1 and 63 octets, but %s given.', $length));
            }
        ...
        if ($length > 255) {
            throw new \Google\Site_Kit_Dependencies\TrueBV\Exception\DomainOutOfBoundsException(\sprintf('A full domain name is limited to 255 octets (including the separators), %s given.', $length));
        }
        return $output;
    }
    /**
