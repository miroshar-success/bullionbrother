						...
						<?php
							foreach ( $cartitem as $itemvalue ) {
								...
								switch ( $itemvalue['table_items'] ) {
									...
									case 'remove':
										echo '<td class="product-remove elementor-repeater-item-'.$itemvalue['_id'].'" data-title="'.$itemvalue['table_heading_title'].'">';
									...
									case 'thumbnail':
										echo '<td class="product-thumbnail elementor-repeater-item-'.$itemvalue['_id'].'" data-title="'.$itemvalue['table_heading_title'].'">';
									...
									case 'customadd':
										echo '<td class="product-wlcustomdata elementor-repeater-item-'.$itemvalue['_id'].'" data-title="'.$itemvalue['table_heading_title'].'">';
