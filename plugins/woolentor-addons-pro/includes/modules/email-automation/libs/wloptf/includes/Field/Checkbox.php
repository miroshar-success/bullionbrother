...
class Checkbox {
    ...
    public function __construct( $args = array(), $store = true ) {
        ...
        $label       = ( isset( $args['label'] ) ? wloptf_cast( $args['label'], 'text' ) : '' );
    ...
    protected function render_field() {
        ...
        ?>
        <input type="checkbox" vlaue="<?php echo esc_attr( $this->value ); ?>" <?php echo wp_kses_data( trim( $add_attr ) ); ?> <?php echo checked( $this->value, 'on', true ) ?>>
        <label><?php echo wp_kses_post($this->label) ?></label>
        <?php
    }
